...
import it.losko.hotel.model.action.EarnInterestsAction;
import it.losko.hotel.model.player.Player;
import it.losko.hotel.view.tui.TUI;

public class EarnInterestsActionListener extends TUIActionListener {

	@Override
	public void actionNotified(final TUI ui, final Action uncastedAction) {
		final EarnInterestsAction action = (EarnInterestsAction) uncastedAction;
