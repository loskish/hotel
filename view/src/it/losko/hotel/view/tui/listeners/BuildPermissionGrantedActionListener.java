...
import it.losko.hotel.model.action.BuildPermissionGrantedAction;
import it.losko.hotel.model.player.Player;
import it.losko.hotel.view.tui.TUI;

public class BuildPermissionGrantedActionListener extends TUIActionListener {

	@Override
	public void actionNotified(final TUI ui, final Action uncastedAction) {
		final BuildPermissionGrantedAction action = (BuildPermissionGrantedAction) uncastedAction;
