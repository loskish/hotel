...
public class BuyActionChooser extends ActionChooser {
	private BuyActionChooser() {
		getCompatible().add(PurchaseAction.class);
	}
	
	private static class SingletonHolder { 
		private static final BuyActionChooser singleton = new BuyActionChooser();
	}
	
	public static BuyActionChooser getSingleton() {
